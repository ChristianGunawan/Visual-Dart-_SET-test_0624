...
public class TestUserCreation {
    ...
    public void create_group() {
        ...
        WebElement createGroupButton = wait.until(
                ExpectedConditions.presenceOfElementLocated(By.xpath("//button[@class=' sendbird-iconbutton ']")));
        WebElement popUpCreateGroupButton = wait.until(
                ExpectedConditions
                        .presenceOfElementLocated(By.xpath("//button[@class='sendbird-add-channel__rectangle']")));
        ...
        WebElement headerMiddle = wait.until(ExpectedConditions
                .presenceOfElementLocated(By.xpath("(//div[@class='sendbird-ui-header__middle'])[2]")));
