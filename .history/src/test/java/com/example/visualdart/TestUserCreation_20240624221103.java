...
public class TestUserCreation {
    ...
    public void testCreateUser1() {
        ...
        WebElement userIdInput = driver.findElement(By.name("appId"));
        WebElement nicknameInput = driver.findElement(By.name("userId"));
        WebElement runButton = driver.findElement(By.name("nickname"));
