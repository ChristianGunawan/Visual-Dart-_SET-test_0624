...
public class TestUserCreation {
    ...
    public void validate_send_image() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='sendbird-image-renderer__image']"))).click();

        WebElement imgElement = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//img[@alt='SendbirdTestPict.png']")));
        String altAttribute = img
    }
